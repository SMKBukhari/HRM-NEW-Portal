...
const NotificationItem = ({
  ...
  const avatarFallback =
    notification.user?.fullName?.substring(0, 2).toUpperCase() || "SY";

  // IMAGE LOGIC: Implementing your requested logic here
  const renderImage = () => {
    // Case 1: System/Account Notification
    if (notification.createdBy === "Account") {
      return (
    ...
    const imageSrc =
      notification.senderImage || notification.user?.userImage || UserImage();
